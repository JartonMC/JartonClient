...
class ResourceFolderModel : public QAbstractListModel {
   ...
   protected:
    ...
    /** Whether a scanned file should be kept out of the model entirely.
     *
     *  Hidden resources never get a row, so the user can't toggle or remove them. The default keeps everything;
     *  subclasses override this to suppress specific files (matched on the on-disk file name).
     */
    [[nodiscard]] virtual bool isHiddenResource(const QString& /*fileName*/) const { return false; }
